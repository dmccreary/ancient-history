...
|---|---------|-------|--------|-------|
| 1 | Concepts | 297 | Required | Concepts from learning graph |
...
| 7 | Glossary Terms | 250 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 100,920 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 21 | 21 | H4 headers starting with '#### Diagram:' |
| Equations | 0 | 0 | LaTeX expressions (inline and display) |
| Total Words | 100,920 | 76,031 | Words in markdown files |
| Links | 92 | 50 | Hyperlinks in markdown format |
| Equivalent Pages | 409 | 309 | Estimated pages (250 words/page + visuals) |
